...
<%--            <c:url value="/admin/customer/update" var="url"></c:url>--%>
            <form:form method="get" modelAttribute="customerEntity">
<%--                       action="${url}"--%>
                ...
                <div class="col-sm-4 form-group">
                    ...
                    <form:checkbox placeholder="User is enabled"
                                   class="form-control" path="user.enabled" readonly="true"></form:checkbox>
                </div>
                <div class="col-sm-4 form-group">
                    ...
                    <form:checkbox placeholder="User is AccountNonExpired"
                                   class="form-control" path="user.accountNonExpired" readonly="true"></form:checkbox>
                </div>
                <div class="col-sm-4 form-group">
                    ...
                    <form:checkbox placeholder="User is CredentialsNonExpired"
                                   class="form-control" path="user.credentialsNonExpired" readonly="true"></form:checkbox>
                </div>
                <div class="col-sm-4 form-group">
                    <form:label path="user.accountNonLocked">Is AccountNonLocked</form:label>
                    <form:checkbox placeholder="User AccountNonLocked"
                                   class="form-control" path="user.accountNonLocked" readonly="true"></form:checkbox>
                </div>
                <div class="row">
